...
public class Recompense {
    ...
    private Integer idFacture; // peut être null

    // Constructeurs
    public Recompense() {}

    public Recompense(String type, double valeur, String description, int seuil, Date dateObtention, int idLivreur, Integer idFacture) {
        this.type = type;
        this.valeur = valeur;
    ...
    public Recompense(int idRecompense, String type, double valeur, String description, int seuil, Date dateObtention, int idLivreur, Integer idFacture) {
